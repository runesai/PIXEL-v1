                    ...
                    if questions:
                        ...
                        if faq_matches:
                            ...
                            for idx, (q, faq) in enumerate(faq_matches):
                                ...
                                # Remove greeting for all but the first answer
                                if skip_greeting:
                                    answer = re.sub(r'^(hi|hello|heyyy|kumusta|kamusta|magandang \\w+|good \\w+|hello, iskolar!|hi, iskolar!|heyyy, iskolar!|hello po|hi po)[!,. ]*', '', answer, flags=re.IGNORECASE)
                        ...
                        for q in non_faq_questions:
                            ...
                            if contains_link_request(q):
                                answers.append("Sorry, I can only provide links that are part of the official FAQ. If you need a specific link, please check the FAQ or ask the department directly.")
                                continue
