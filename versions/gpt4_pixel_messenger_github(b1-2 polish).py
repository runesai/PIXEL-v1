            ...
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):
                    ...
                    if is_illegal_query(message_text):
                        illegal_msg = ("Sorry, I can't help with that. Your question is not allowed and I strongly discourage such actions." if lang == 'en' else "Paumanhin, hindi ako pwedeng tumulong diyan. Ang iyong tanong ay hindi pinapayagan at hindi ko hinihikayat ang ganitong gawain.")
                        bot.send_text_message(sender_id, illegal_msg)
                        continue
